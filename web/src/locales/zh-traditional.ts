export default {
  translation: {
    ...
    devSettingPanython: {
      ...
      tenantRelationsTitle: '租戶關係維護',
      tenantRelationsDescription:
        '按租戶展示成員、聊天助手和助手可訪問知識庫。用戶加入某個租戶後，就能使用該租戶下發布的助手；助手可以在這裡維護可訪問知識庫。',
      selectUser: '選擇用戶',
      selectTenant: '選擇租戶',
      saveUserTenant: '保存用戶歸屬',
      tenantRelationSaved: '租戶關係已保存',
      tenantRelationDeleted: '租戶關係已刪除',
      deleteRelationBlocked: '不能刪除該上級關係，仍存在下級資產：{{blockers}}',
      deleteRelationConfirm:
        '確認刪除 {{user}} -> {{tenant}} 的關係？該操作會影響該用戶可見範圍。',
      transferDialogConfirm:
        '確認把聊天助手「{{dialog}}」遷移到租戶「{{tenant}}」？',
      dialogTenantSaved: '聊天助手歸屬已調整',
      dialogKnowledgeSaved: '聊天助手知識庫已更新',
      updateFailed: '更新失敗',
      unknownTenant: '未知租戶',
      unnamedTenant: '未命名租戶',
      unnamedUser: '未命名用戶',
      tenantLabel: '租戶：{{tenant}}',
      tenantSummary:
        '{{users}} 個用戶 / {{dialogs}} 個聊天助手 / {{kbs}} 個知識庫',
      usersInTenant: '屬於該租戶的用戶',
      noTenantUsers: '暫無用戶歸屬到該租戶',
      userBelongsToTenant: '{{user}} 屬於 {{tenant}}',
      removeUserTenant: '移除用戶歸屬',
      hasDependentAssets: '仍有下級資產：{{blockers}}',
      tenantKnowledgebases: '該租戶的知識庫',
      noKnowledgebases: '暫無知識庫',
      kbStats: '{{docs}} 文件 / {{chunks}} 切片 / {{permission}}',
      noDialogsInTenant: '該租戶下暫無聊天助手。',
      dialogLabel: '聊天助手：{{dialog}}',
      dialogTenantAccess: '租戶「{{tenant}}」的成員可以使用該助手。',
      moveToTenant: '遷移到其他租戶',
      saveOwner: '保存歸屬',
      accessibleKnowledgebases: '可訪問知識庫',
      selectedKbCount: '已選 {{count}} 個',
      kbTenantTooltip: '{{kb}} 屬於租戶 {{tenant}}',
