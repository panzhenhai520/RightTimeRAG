export default {
  translation: {
    ...
    login: {
      appName: 'RhightTime Professional AI Consultant System',
      headName: 'Dr. Right',
      ...
      loginUserNamePlaceholder: 'Please input username',
    ...
    devSettingPanython: {
      pageTitle: 'Panython development management',
      pageDescription:
      ...
      createAgentDescription:
        'Create an agent from a template or a blank workflow, then enter the workflow builder.',
      ...
      selectTenant: 'Select user group',
      selectUserGroup: 'Select user group',
      saveUserTenant: 'Save group member',
      saveUserGroupMembership: 'Save group member',
      tenantRelationSaved: 'User group membership saved',
      tenantRelationDeleted: 'User group membership deleted',
      deleteRelationBlocked:
        'This parent relationship cannot be deleted because dependent assets still exist: {{blockers}}',
      deleteRelationConfirm:
        'Remove {{user}} from user group {{tenant}}? This affects the user visibility scope.',
      transferDialogConfirm:
        'Move chat assistant "{{dialog}}" to user group "{{tenant}}"?',
      dialogTenantSaved: 'Chat assistant user group updated',
      dialogKnowledgeSaved: 'Chat assistant knowledge-base access updated',
      updateFailed: 'Update failed',
      unknownTenant: 'Unknown user group',
      unnamedTenant: 'Unnamed user group',
      unnamedUser: 'Unnamed user',
      tenantLabel: 'User group: {{tenant}}',
      userGroupLabel: 'User group: {{group}}',
      tenantSummary:
        '{{users}} users / {{dialogs}} chat assistants / {{kbs}} knowledge bases',
      usersInTenant: 'Group members',
      groupMembers: 'Group members',
      noTenantUsers: 'No users have joined this group yet',
      userBelongsToTenant: '{{user}} belongs to group {{tenant}}',
      removeUserTenant: 'Remove group member',
      hasDependentAssets: 'Dependent assets still exist: {{blockers}}',
      tenantKnowledgebases: 'Knowledge bases in this group',
      groupKnowledgebases: 'Knowledge bases in this group',
      noKnowledgebases: 'No knowledge bases',
      kbStats: '{{docs}} docs / {{chunks}} chunks / {{permission}}',
      noDialogsInTenant: 'No chat assistants under this group.',
      dialogLabel: 'Chat assistant: {{dialog}}',
      dialogTenantAccess:
        'Members of user group "{{tenant}}" can use this assistant.',
      groupAssistants: 'Chat assistants available to this group',
      moveToTenant: 'Move to another group',
      saveOwner: 'Save group',
      accessibleKnowledgebases: 'Accessible knowledge bases',
      selectedKbCount: '{{count}} selected',
      kbTenantTooltip: '{{kb}} belongs to user group {{tenant}}',
      ...
      assetAgents: 'Agents',
      assetMemories: 'Memories',
      assetModels: 'Models',
      noDependentAssets: 'No dependent assets',
      roleNormal: 'Member',
      ...
      ttsSaved: 'TTS engine settings saved',
      enableTtsFirst: 'Enable TTS first',
      previewFailed: 'Speech preview failed',
      enableTts: 'Enable TTS',
      enableTtsDescription:
        'When disabled, no caching, queueing, or delayed text output is used.',
      engineName: 'Engine name',
      engineCapabilities: 'Engine capabilities',
      ttsCapabilitySpeed: 'Speed',
      ttsCapabilityEmotion: 'Emotion',
      ttsCapabilityDialect: 'Dialect',
      ttsCapabilityVoice: 'Voice profile',
      ttsCapabilitySync: 'Synchronized captions',
      defaultSpeed: 'Default speed',
      currentSpeed: 'Current {{speed}}x',
      defaultEmotion: 'Default emotion',
      defaultDialect: 'Default Chinese dialect',
      defaultGender: 'Default gender',
      genderFemale: 'Female',
      genderMale: 'Male',
      defaultVoiceProfile: 'Default voice profile',
      currentVoiceProfile: 'Current: {{profile}}',
      bufferMs: 'Initial buffer',
      bufferMsValue: '{{value}} ms',
      bufferMsHelp:
        'Initial buffer controls how much speech is cached before the first audio starts, in milliseconds. Increase it when the network or TTS generation stutters at the beginning; lower it when faster speech startup is more important.',
      zhSegmentChars: 'Chinese segment chars',
      zhSegmentCharsValue: '{{value}} chars',
      zhSegmentCharsHelp:
        'Chinese segment chars controls how many Chinese characters are sent to TTS per segment. Smaller segments start sooner with more joins; larger segments sound smoother but wait longer.',
      enSegmentWords: 'English segment words',
      enSegmentWordsValue: '{{value}} words',
      enSegmentWordsHelp:
        'English segment words controls how many English words are sent to TTS per segment. Lower it if playback stalls; raise it if long sentences sound too fragmented.',
      preview: 'Preview',
      saveTts: 'Save TTS settings',
      ttsPreviewText:
        'Welcome to RightTime professional AI advisor. This is a speech preview.',
      ttsSpeedSlow: 'Slow 0.8x',
      ttsSpeedNormal: 'Normal 1.0x',
      ttsSpeedSlightlyFast: 'Slightly fast 1.15x',
      ttsSpeedFast: 'Fast 1.3x',
      ttsEmotionProfessional: 'Professional',
      ttsEmotionCalm: 'Calm',
      ttsEmotionFriendly: 'Friendly',
      ttsEmotionFormal: 'Formal',
      ttsEmotionLively: 'Lively',
      ttsEmotionSerious: 'Serious',
      ttsDialectMandarin: 'Mandarin',
      ttsDialectCantonese: 'Cantonese',
      ttsDialectSichuan: 'Sichuan',
      ttsDialectShanghai: 'Shanghai',
      ttsDialectDongbei: 'Northeastern',
      ttsDialectMinnan: 'Minnan',
      ttsDialectTianjin: 'Tianjin',
      ttsDialectShandong: 'Shandong',
      ttsVoiceFemaleMandarin: 'Female / Mandarin / Standard',
      ttsVoiceMaleMandarin: 'Male / Mandarin / Standard',
      ttsVoiceFemaleCantonese: 'Female / Cantonese / Standard',
      ttsVoiceMaleCantonese: 'Male / Cantonese / Standard',
      ttsVoiceFemaleEnglish: 'Female / English / Standard',
      ttsVoiceMaleEnglish: 'Male / English / Standard',
      ttsVoiceProfilesTitle: 'Voice profile library',
      ttsVoiceProfilesDescription:
        'Record your voice to create a custom voice profile — no audio sample needed in advance.',
      ttsVoiceProfilesRefresh: 'Refresh',
      ttsVoiceProfilesAdd: 'New voice profile',
      ttsVoiceProfilesBuiltIn: 'Built-in profiles',
      ttsVoiceProfilesCustom: 'Custom profiles',
      ttsVoiceProfilesEmpty: 'No custom voice profiles yet',
      ttsVoiceProfilesDeleteConfirm:
        'Delete voice profile "{{name}}"? This cannot be undone.',
      ttsVoiceProfilesDeleted: 'Voice profile deleted',
      ttsAddVoiceTitle: 'New voice profile',
      ttsAddVoiceId: 'Profile ID',
      ttsAddVoiceIdPlaceholder: 'my_custom_voice',
      ttsAddVoiceIdHelp:
        'Alphanumeric + underscores, 1-64 chars. Used to reference this voice in assistant settings.',
      ttsAddVoiceDisplayName: 'Display name',
      ttsAddVoiceDisplayNamePlaceholder: 'Mr. Li / Mandarin',
      ttsAddVoicePromptText: 'Text to record',
      ttsAddVoicePromptTextPlaceholder:
        'Read this text aloud when recording (5-10 seconds recommended)',
      ttsAddVoicePromptTextHelp:
        'Read this text while recording. CosyVoice3 uses it as the voice reference.',
      ttsAddVoiceRecord: 'Start recording',
      ttsAddVoiceRecording: 'Recording… click to stop',
      ttsAddVoiceRecorded: 'Done ({{seconds}}s) — play back or re-record',
      ttsAddVoicePlay: 'Play recording',
      ttsAddVoiceReRecord: 'Re-record',
      ttsAddVoiceSave: 'Save voice profile',
...
Procedural Memory: Learned skills, habits, and automated procedures.`,
      ...
      spacetime: {
        ...
        keywordAnalysis: 'Keyword connections',
        noKeywords: 'No keyword links yet.',
        selectedMemo: 'Selected memo',
        openMemo: 'Open memo',
        selectHint: 'Select a circle to inspect this memo.',
        emptyTitle: 'No memos to visualize',
        emptyDescription: 'Create a memo or add a chat session to memo first.',
        loaded: 'Memory center loaded',
        nodes: 'nodes',
        viewportControls: 'Viewport dimensions and panning',
        horizontalPan: 'Horizontal date panning. You can also drag the canvas.',
        firstDay: 'First',
        globalZoom: 'Proportional canvas zoom',
        spacetimeClues: 'Spacetime clues',
        focusDateHint: 'Choose a focus date. Updates immediately.',
        noTimeRange: 'No records',
        memoryExtraction: 'Memo extraction [{{date}}]',
        noDateNodes: 'No memo data at this coordinate',
        memoryFrequency: 'Memo frequency',
        totalTurns: 'Total turns',
        containsCategories: 'Categories',
        timeSpan: 'Time span',
        emptyDateHint: 'The viewport has moved to this empty coordinate.',
        keywordClues: 'Keyword horizontal clues',
        keywordCluesDescription:
          'Cluster overlapping keywords across time and locate the strongest similar circuit.',
        analyzeGlobalWeave: 'Analyze global strongest weave',
        horizontalReport: 'Horizontal clue report',
        strongTies: 'Strong ties',
        subnetwork: 'Related subnetwork',
        horizontalSpan: 'Horizontal time span',
        primaryNodeHint:
          'Located the core hub node: {{topic}}. The related weave is highlighted.',
        selectedPointInfo: 'Selected memory point',
        createdDate: 'Date',
        exactTime: 'Time',
        turnsScale: 'Conversation turns',
        coreKeywords: 'Core keywords',
        sharedMemos: 'Shared related memos',
      ...
      profile: {
        ...
        whatIsProfile: 'What this profile means',
        whatIsProfileDescription:
        ...
        sources: 'Sources',
        evidenceMemos: 'Evidence memos',
        learningPath: 'Learning path',
        recentChanges: 'Recent changes',
        recentPeriod: 'Recent',
        previousPeriod: 'Previous',
        traceableMemos: 'Traceable memos',
        analysisPending: 'Updating thinking profile',
        analysisPendingDescription:
          'The page loads the cached profile first. A new profile snapshot is being generated in the background and will refresh automatically.',
        currentProfile: 'Current thinking profile',
        ...
        pathMap: 'Thinking path map',
        pathMapDescription:
          'Horizontal axis is time; vertical lanes are domains. Nodes are saved memo thinking events, and curves explain topic relationships.',
        edgeEvidence: 'Connection evidence',
        openEvidenceMemo: 'Open source memo',
        predictedQuestions: 'Possible next questions',
        topicMergeSuggestions: 'Topic merge suggestions',
        topicMergeSuggestionsDescription:
          'Confirm only when two topics are the same concept in different wording or different languages.',
        mergeTo: 'Merge to',
        mergeConfidence: 'Confidence',
        confirmMerge: 'Confirm merge',
        activeTopicMerges: 'Active topic merges',
        undoMerge: 'Undo merge',
        algorithmSources: 'Algorithm sources and borrowed ideas',
    ...
    memory: {
      ...
      messages: {
        ...
        contentEmbedHint:
          'Embedding vector is stored for semantic retrieval and is hidden from normal reading.',
        content: 'Content',
        emptyMemoTitle: 'No memo content yet',
        emptyMemoDescription:
          'This area shows memory messages that have been saved and indexed for retrieval. If it is empty, this memo has no saved conversation summary yet, or the background memory extraction task has not finished.',
...
Example: A 1 KB message with 1024-dim embedding uses ~9 KB. The 5 MB default limit holds ~500 such messages.`,
    ...
    knowledgeDetails: {
      ...
      retrievalTestingDescription:
        'Conduct a retrieval test to check if Panython can recover the intended content for the LLM.',
      Parse: 'Parse',
      dataset: 'Dataset',
      ...
      testingDescription:
        'Conduct a retrieval test to check if Panython can recover the intended content for the LLM. If you have adjusted the default settings, such as keyword similarity weight or similarity threshold, to achieve the optimal results, be aware that these changes will not be automatically saved. You must apply them to your chat assistant settings or the Retrieval agent component settings.',
      similarityThreshold: 'Similarity threshold',
      ...
      uploadDescription:
        'Supports single or batch file upload. For a locally deployed Panython: the total file size limit per upload is 1GB, with a batch upload limit of 32 files. There is no cap on the total number of files per account. For cloud.Panython.io, the total file size limit per upload is 10MB, with each file not exceeding 10MB and a maximum of 128 files per account.',
      chunk: 'Chunk',
      bulk: 'Bulk',
      cancel: 'Cancel',
      close: 'Close',
      ...
      rerankTip: `Optional. If left empty, Panython will use a combination of weighted keyword similarity and weighted vector cosine similarity; if a rerank model is selected, a weighted reranking score will replace the weighted vector cosine similarity. Please be aware that using a rerank model will significantly increase the system's response time. If you wish to use a rerank model, ensure you use a SaaS reranker; if you prefer a locally deployed rerank model, ensure you start Panython with docker-compose-gpu.yml.`,
      topK: 'Top-K',
      ...
      html4excelTip: `Use with the General chunking method. When disabled, spreadsheets (XLSX or XLS(Excel 97-2003)) in the dataset will be parsed into key-value pairs. When enabled, they will be parsed into HTML tables, splitting every 12 rows if the original table has more than 12 rows. See https://Panython.io/docs/dev/enable_excel2html for details.`,
      autoKeywords: 'Auto-keyword',
      autoKeywordsTip: `Automatically extract N keywords for each chunk to increase their ranking for queries containing those keywords. Be aware that extra tokens will be consumed by the indexing model specified in 'Configuration'. You can check or update the added keywords for a chunk from the chunk list. For details, see https://Panython.io/docs/dev/autokeyword_autoquestion.`,
      autoQuestions: 'Auto-question',
      autoQuestionsTip: `Automatically extract N questions for each chunk to increase their ranking for queries containing those questions. You can check or update the added questions for a chunk from the chunk list. This feature will not disrupt the chunking process if an error occurs, except that it may add an empty result to the original chunk. Be aware that extra tokens will be consumed by the indexing model specified in 'Configuration'. For details, see https://Panython.io/docs/dev/autokeyword_autoquestion.`,
...
`,
    ...
    knowledgeConfiguration: {
      ...
      tableColumnModeAutoDescription:
        'All columns are included in chunk text and stored as metadata (Panython default).',
...
`,
      useRaptor: 'RAPTOR',
      useRaptorTip:
        'RAPTOR can be used for multi-hop question-answering tasks. Navigate to the Files page, click Generate > RAPTOR to enable it. See https://Panython.io/docs/dev/enable_raptor for details.',
      prompt: 'Prompt',
      promptTip:
...
The above is the content you need to summarize.`,
      ...
      vietnamese: 'Vietnamese',
      pageRank: 'Page rank',
      pageRankTip: `You can assign a higher PageRank score to specific datasets during retrieval. The corresponding score is added to the hybrid similarity scores of retrieved chunks from these datasets, increasing their ranking. See https://Panython.io/docs/dev/set_page_rank for details.`,
      tagName: 'Tag',
      frequency: 'Frequency',
      ...
      tagSet: 'Tag sets',
      tagSetTip: `
     <p> Select one or multiple tag datasets to auto-tag chunks in your dataset. See https://Panython.io/docs/dev/use_tag_sets for details.</p>
...
<ul>
  ...
  <li>The auto-keyword feature is dependent on the LLM and consumes a significant number of tokens.</li>
    ...
    chat: {
      ...
      chatApps: 'Chat apps',
      chatAssistantCount: '{{count}} chat assistants',
      createChatAssistant: 'Create chat assistant',
      historySessionCount: '{{count}} history conversations',
      ...
      addToMemoryTopicPrompt:
        'Memo topic (optional). Leave blank to use the first user question as the topic. Content is saved first.',
      ...
      processAnalyze: 'Analyze the question',
      processRetrieve: 'Retrieve from datasets',
      processReason: 'Reason and organize evidence',
      processCompose: 'Compose the answer',
      processDone: 'Done',
      ...
      recallEmpty: 'Retrieved evidence and documents will appear here',
      recallDocumentsCount: '{{count}} documents',
      evidenceAuditStats:
      ...
      answerEvidencePlanHint:
        'Shows which evidence each answer claim cites and how reliable it is',
      evidenceStrengthStrong: 'Strong evidence',
      evidenceStrengthMedium: 'Medium evidence',
      evidenceStrengthWeak: 'Weak evidence',
      evidenceStrengthUnknown: 'Unknown evidence',
      evidenceCitesLabel: 'Cites',
      recallExpand: 'Expand',
      recallCollapse: 'Restore',
      openEvidenceInRecall: 'Open Fig. {{fig}} detail',
      ...
      voiceNoText: 'No speech was recognized',
      voiceError:
        'Speech transcription failed. Check microphone permission and speech-to-text model settings.',
...
**Essential Rules:**
  ...
  - **Always consider** the entire conversation history.`,
      ...
      **Essential Rules:**
      ...
      variable: 'Variable',
      variableTip: `Used together with Panython's chat assistant management APIs, variables can help develop more flexible system prompt strategies. The defined variables will be used by 'System prompt' as part of the prompts for the LLM. {knowledge} is a reserved special variable representing chunks retrieved from specified dataset(s), and all variables should be enclosed in curly braces {} in the 'System prompt'. See https://Panython.io/docs/dev/set_chat_variables for details.`,
      add: 'Add',
      key: 'Key',
      optional: 'Optional',
      operation: 'Operation',
      ...
      betaError:
        'Please acquire a Panython API key from the System Settings page first.',
      searching: 'Searching...',
      parsing: 'Parsing',
      uploading: 'Uploading',
      ...
      ttsVoiceProfile: 'Voice profile',
      ttsGender: 'Voice gender',
      ttsGenderFemale: 'Female',
      ttsGenderMale: 'Male',
      ttsEmotion: 'Voice emotion',
      ttsEmotionProfessional: 'Professional',
      ttsEmotionCalm: 'Calm',
      ttsEmotionFriendly: 'Friendly',
      ttsEmotionFormal: 'Formal',
      ...
      ttsDialectSichuan: 'Sichuan',
      ttsDialectShanghai: 'Shanghai',
      ttsDialectDongbei: 'Northeastern Mandarin',
      ttsDialectMinnan: 'Minnan',
...
Example: Virtual Hosted Style`,
      ...
      embeddingModelTip:
        'The default embedding model for each newly created dataset. If you cannot find an embedding model from the dropdown, check if you are using Panython slim edition (which does not include embedding models) or check https://Panython.io/docs/dev/supported_models to see if your model provider supports this model.',
      img2txtModel: 'VLM',
      img2txtModelTip:
        'The default VLM for each newly created dataset. It describes a picture or video. If you cannot find a model from the dropdown, check https://Panython.io/docs/dev/supported_models to see if your model provider supports this model.',
      ...
      rerankModel: 'Rerank',
      rerankModelTip: `The default rerank model for reranking chunks. If you cannot find a model from the dropdown, check https://Panython.io/docs/dev/supported_models to see if your model provider supports this model.`,
      ttsModel: 'TTS',
      ttsModelTip:
        'The default text-to-speech model. If you cannot find a model from the dropdown, check https://Panython.io/docs/dev/supported_models to see if your model provider supports this model.',
      workspace: 'workspace',
      upgrade: 'Upgrade',
      addLlmTitle: 'Add LLM',
