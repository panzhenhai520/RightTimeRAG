...
class Dialog(DataBaseModel):
    ...
    memory_mode = CharField(
        max_length=32,
        null=False,
        default="kb_first",
        help_text="kb_first|memory_first|ignore_memory",
    )
...
def migrate_db():
    ...
    alter_db_add_column(migrator, "dialog", "memory_mode", CharField(max_length=32, null=False, default="kb_first", help_text="kb_first|memory_first|ignore_memory"))
