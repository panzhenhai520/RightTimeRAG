export default {
  translation: {
    ...
    devSettingPanython: {
      ...
      tenantRelationsTitle: 'Tenant relationship management',
      tenantRelationsDescription:
        'View users, chat assistants, and accessible knowledge bases by tenant. A user can use assistants published under their tenant, and assistant knowledge-base access can be maintained here.',
      selectUser: 'Select user',
      selectTenant: 'Select tenant',
      saveUserTenant: 'Save membership',
      tenantRelationSaved: 'Tenant relationship saved',
      tenantRelationDeleted: 'Tenant relationship deleted',
      ...
      deleteRelationConfirm:
        'Delete the relationship {{user}} -> {{tenant}}? This affects the user visibility scope.',
      transferDialogConfirm:
        'Move chat assistant "{{dialog}}" to tenant "{{tenant}}"?',
      dialogTenantSaved: 'Chat assistant owner tenant updated',
      ...
      usersInTenant: 'Users in this tenant',
      noTenantUsers: 'No users belong to this tenant yet',
      userBelongsToTenant: '{{user}} belongs to {{tenant}}',
      removeUserTenant: 'Remove membership',
      hasDependentAssets: 'Dependent assets still exist: {{blockers}}',
      tenantKnowledgebases: 'Knowledge bases in this tenant',
      noKnowledgebases: 'No knowledge bases',
      kbStats: '{{docs}} docs / {{chunks}} chunks / {{permission}}',
      noDialogsInTenant: 'No chat assistants under this tenant.',
      dialogLabel: 'Chat assistant: {{dialog}}',
      dialogTenantAccess:
        'Members of tenant "{{tenant}}" can use this assistant.',
      moveToTenant: 'Move to another tenant',
      saveOwner: 'Save owner',
      accessibleKnowledgebases: 'Accessible knowledge bases',
      selectedKbCount: '{{count}} selected',
      kbTenantTooltip: '{{kb}} belongs to tenant {{tenant}}',
