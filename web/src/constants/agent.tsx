...
export enum Operator {
  ...
  WorkspaceFileWrite = 'WorkspaceFileWrite',
  WorkspacePatchApply = 'WorkspacePatchApply',
  PromptTemplate = 'PromptTemplate',
  ScoreRubricBuilder = 'ScoreRubricBuilder',
  PronunciationJudge = 'PronunciationJudge',
  SummaryNode = 'SummaryNode',
  ReportComposer = 'ReportComposer',
  ContractClauseExtractor = 'ContractClauseExtractor',
  ComplianceChecklistGenerator = 'ComplianceChecklistGenerator',
  ClauseMatcher = 'ClauseMatcher',
  ComplianceVerifier = 'ComplianceVerifier',
  RiskScorer = 'RiskScorer',
  ComplianceReportComposer = 'ComplianceReportComposer',
  DocGenerator = 'DocGenerator',
  AudioInput = 'AudioInput',
  TTSGenerate = 'TTSGenerate',
  ASRTranscribe = 'ASRTranscribe',
  VoiceReplyOutput = 'VoiceReplyOutput',
  MeetingContextInput = 'MeetingContextInput',
  MemoryInject = 'MemoryInject',
  AgentFanout = 'AgentFanout',
  ResultAggregator = 'ResultAggregator',
  WebhookInput = 'WebhookInput',
  ExternalScoreReceiver = 'ExternalScoreReceiver',
  ...
  ScopedDBConnector = 'ScopedDBConnector',
  SafeTableEnsure = 'SafeTableEnsure',
  SafeRecordInsert = 'SafeRecordInsert',
  SafeRecordUpdate = 'SafeRecordUpdate',
  SafeRecordQuery = 'SafeRecordQuery',
  Browser = 'Browser',
