export default {
  translation: {
    ...
    devSettingPanython: {
      ...
      tenantRelationsTitle: '租户关系维护',
      tenantRelationsDescription:
        '按租户展示成员、聊天助手和助手可访问知识库。用户加入某个租户后，就能使用该租户下发布的助手；助手可以在这里维护可访问知识库。',
      selectUser: '选择用户',
      selectTenant: '选择租户',
      saveUserTenant: '保存用户归属',
      tenantRelationSaved: '租户关系已保存',
      tenantRelationDeleted: '租户关系已删除',
      deleteRelationBlocked: '不能删除该上级关系，仍存在下级资产：{{blockers}}',
      deleteRelationConfirm:
        '确认删除 {{user}} -> {{tenant}} 的关系？该操作会影响该用户可见范围。',
      transferDialogConfirm:
        '确认把聊天助手「{{dialog}}」迁移到租户「{{tenant}}」？',
      dialogTenantSaved: '聊天助手归属已调整',
      dialogKnowledgeSaved: '聊天助手知识库已更新',
      updateFailed: '更新失败',
      unknownTenant: '未知租户',
      unnamedTenant: '未命名租户',
      unnamedUser: '未命名用户',
      tenantLabel: '租户：{{tenant}}',
      tenantSummary:
        '{{users}} 个用户 / {{dialogs}} 个聊天助手 / {{kbs}} 个知识库',
      usersInTenant: '属于该租户的用户',
      noTenantUsers: '暂无用户归属到该租户',
      userBelongsToTenant: '{{user}} 属于 {{tenant}}',
      removeUserTenant: '移除用户归属',
      hasDependentAssets: '仍有下级资产：{{blockers}}',
      tenantKnowledgebases: '该租户的知识库',
      noKnowledgebases: '暂无知识库',
      kbStats: '{{docs}} 文件 / {{chunks}} 切片 / {{permission}}',
      noDialogsInTenant: '该租户下暂无聊天助手。',
      dialogLabel: '聊天助手：{{dialog}}',
      dialogTenantAccess: '租户「{{tenant}}」的成员可以使用该助手。',
      moveToTenant: '迁移到其他租户',
      saveOwner: '保存归属',
      accessibleKnowledgebases: '可访问知识库',
      selectedKbCount: '已选 {{count}} 个',
      kbTenantTooltip: '{{kb}} 属于租户 {{tenant}}',
