export default {
  translation: {
    common: {
      ...
      submit: '提交',
      clear: '清空',
      filterSelectedCount: '筛选。已选择 {{count}} 个条件。',
      embedIntoSite: '嵌入网站',
    ...
    login: {
      appName: '时和家辩专业AI顾问系统',
      headName: '時博士 Dr. Right',
      loginTitle: '登录账户',
      signUpTitle: '创建账户',
      login: '登录',
      signUp: '注册',
      ...
      emailLabel: '邮箱',
      loginUserNameLabel: '用户',
      loginUserNamePlaceholder: '请输入用户',
    ...
    homeBanner: {
      welcomeFull: '欢迎访问时和专业AI顾问',
      welcomePrefix: '欢迎访问',
      productName: '时和专业AI顾问',
      setupScriptBtn: '一键安装 right.time 证书',
      setupScriptHint:
        '下载后双击运行，自动完成证书安装和域名配置（需 Windows 管理员权限，会弹出授权对话框）',
      certOnlyBtn: '仅下载证书',
      certOnlyHint: '下载 CA 根证书，手动安装',
    },
    header: {
      knowledgeBase: '知识库',
      chat: '聊天',
    ...
    homeDashboard: {
      chatAssistants: '聊天助手',
      chatAssistantsDescription: '选择已经配置好的专业助手，直接开始问答。',
      searchTools: '搜索助手',
      searchToolsDescription: '进入专门的搜索工具，按文档和证据检索资料。',
      publishedAgents: '已发布智能体',
      publishedAgentsDescription:
        '运行已经发布的智能体，普通用户不可编辑流程。',
      knowledgeAssets: '知识库',
      knowledgeAssetsDescription: '查看可用知识资产、文档数量和最近更新。',
      recentMemos: '最近备忘录',
    ...
    devSettingPanython: {
      pageTitle: 'Panython 开发管理',
      pageDescription: '这些功能用于后台配置，不在普通用户工作台展示。',
      tabMenus: '功能入口',
      tabAssistant: '助手配置',
      tabTts: 'TTS 语音',
      tabAsr: 'ASR 识别',
      identityTitle: '全局助手身份',
      identityDescription:
        '此处的文字将自动注入所有助手的系统提示词开头，所有对话无条件继承。修改后立即生效，无需重启服务。',
      identityPlaceholder: '输入助手的身份说明和自我认知...',
      identitySaveBtn: '保存',
      identitySaved: '身份配置已保存',
      tabUsers: '用户注册',
      tabTenants: '用户组设置',
      tabLogs: '日志',
      open: '打开',
      ...
      optionDisabled: '禁用',
      createDataset: '新建知识库',
      createDatasetDescription: '创建知识库、选择解析方式并导入业务文档。',
      createChat: '新建聊天助手',
      createChatDescription: '创建并配置聊天助手、模型、提示词和关联知识库。',
      createSearch: '新建搜索助手',
      createSearchDescription: '创建并配置搜索助手、搜索范围和结果呈现方式。',
      agents: '智能体',
      agentsDescription: '管理预定义智能体和流程编排。',
      createAgent: '新建智能体',
      createAgentDescription:
        '从模板或空白流程创建智能体，并进入流程编排向导。',
      memory: '记忆整理',
      memoryDescription: '管理记忆、消息整理和后续备忘录扩展。',
      files: '文件管理',
      ...
      saveUserTenant: '保存用户组成员',
      saveUserGroupMembership: '保存用户组成员',
      tenantRelationSaved: '用户组成员关系已保存',
      tenantRelationDeleted: '用户组成员关系已删除',
      deleteRelationBlocked: '不能删除该上级关系，仍存在下级资产：{{blockers}}',
      deleteRelationConfirm:
        '确认把 {{user}} 从用户组 {{tenant}} 中移除？该操作会影响该用户可见范围。',
      transferDialogConfirm:
        '确认把聊天助手「{{dialog}}」迁移到用户组「{{tenant}}」？',
      dialogTenantSaved: '聊天助手所属用户组已调整',
      dialogKnowledgeSaved: '聊天助手知识库已更新',
      updateFailed: '更新失败',
      unknownTenant: '未知用户组',
      unnamedTenant: '未命名用户组',
      unnamedUser: '未命名用户',
      tenantLabel: '用户组：{{tenant}}',
      userGroupLabel: '用户组：{{group}}',
      tenantSummary:
        '{{users}} 个用户 / {{dialogs}} 个聊天助手 / {{kbs}} 个知识库',
      usersInTenant: '用户组成员',
      groupMembers: '用户组成员',
      noTenantUsers: '暂无用户加入该用户组',
      userBelongsToTenant: '{{user}} 属于用户组 {{tenant}}',
      removeUserTenant: '移除用户组成员',
      hasDependentAssets: '仍有下级资产：{{blockers}}',
      tenantKnowledgebases: '该用户组的知识库',
      groupKnowledgebases: '该用户组的知识库',
      noKnowledgebases: '暂无知识库',
      kbStats: '{{docs}} 文件 / {{chunks}} 切片 / {{permission}}',
      noDialogsInTenant: '该用户组下暂无聊天助手。',
      dialogLabel: '聊天助手：{{dialog}}',
      dialogTenantAccess: '用户组「{{tenant}}」的成员可以使用该助手。',
      groupAssistants: '该用户组可用的聊天助手',
      moveToTenant: '迁移到其他用户组',
      saveOwner: '保存所属用户组',
      accessibleKnowledgebases: '可访问知识库',
      selectedKbCount: '已选 {{count}} 个',
      kbTenantTooltip: '{{kb}} 属于用户组 {{tenant}}',
      noBindableKnowledgebases: '暂无可绑定知识库。',
      kbOptionMeta: '{{tenant}} / {{docs}} 文件 / {{chunks}} 切片',
      saveKnowledgeAccess: '保存知识库权限',
      assetMembers: '成员',
      assetDatasets: '知识库',
      assetDialogs: '聊天',
      assetSearches: '搜索',
      ...
      deleteGroupBlocked:
        '不能删除该用户组，下面仍有用户或资源：{{blockers}}。请先迁移或删除下级内容。',
      deleteGroupConfirm:
        '确认删除用户组「{{tenant}}」？删除后该用户组入口不可用，该操作会记录日志。',
      userGroupDeleted: '用户组已删除',
      deleteDialog: '删除助手',
      deleteDialogConfirm:
        '确认删除聊天助手「{{dialog}}」？删除后用户将不能继续使用该助手，相关历史入口可能不可见。该操作会记录日志。',
      dialogDeleted: '聊天助手已删除',
      operationLogsTitle: '用户管理操作日志',
      operationLogsDescription:
        '记录用户组、用户组成员和聊天助手归属相关操作。当前共 {{total}} 条。',
      logOperator: '操作人',
      logAction: '操作',
      logTarget: '对象',
      logTime: '时间',
      noOperationLogs: '暂无操作日志',
      operation_user_group_membership_create: '新增用户组成员',
      ...
      operation_chat_message_delete: '删除聊天问答轮次',
      ...
      asrTitle: 'ASR 语音识别路由',
      asrDescription:
        '配置语音输入的识别模型和路由策略。支持 Qwen3-ASR（高精度，粤语/混语）和 SenseVoice（低延迟，多任务）双路切换。',
      asrSaved: 'ASR 配置已保存',
      asrMode: '路由模式',
      asrModeDual: '双路并行（推荐）',
      asrModeSingle: '单路',
      ...
      asrDualMerge: '结果合并策略',
      asrMergeQwen3Primary: 'Qwen3 优先（SenseVoice 备用）',
      asrMergeSVPrimary: 'SenseVoice 优先（Qwen3 备用）',
      asrMergeLongest: '取字数更多者',
      asrLanguage: '默认识别语言',
      asrLangAuto: '自动检测',
      asrLangCantonese: '粤语',
      asrLangMandarin: '普通话',
      asrLangEnglish: '英语',
      asrShortThreshold: '短音频阈值',
      asrPunctuation: '标点恢复（FunASR）',
      asrPunctuationHelp:
        '使用 FunASR ct-punc 模型对识别结果自动添加标点，对中文效果最佳。',
      asrVad: '语音活动检测（VAD）',
      asrVadHelp:
        '使用 FunASR fsmn-vad 检测语音端点并裁剪首尾静音，减少幻觉识别。',
      ttsEngineTitle: 'TTS 语音引擎',
      ttsEngineDescription:
        '只有在这里启用 TTS，并声明引擎支持对应能力后，聊天助手和智能体才显示语音参数配置。',
      ttsSaved: 'TTS 引擎配置已保存',
      enableTtsFirst: '请先启用 TTS 语音能力',
      previewFailed: '试听生成失败',
      enableTts: '启用 TTS 语音能力',
      enableTtsDescription: '关闭后不缓存、不排队、不延迟文字输出。',
      engineName: '引擎名称',
      engineCapabilities: '引擎能力声明',
      ttsCapabilitySpeed: '语速',
      ttsCapabilityEmotion: '情绪',
      ttsCapabilityDialect: '方言',
      ttsCapabilityVoice: '音色 Profile',
      ttsCapabilitySync: '声文同步',
      defaultSpeed: '默认语速',
      currentSpeed: '当前 {{speed}}x',
      defaultEmotion: '默认情绪',
      defaultDialect: '默认中文方言',
      defaultGender: '默认性别',
      genderFemale: '女声',
      genderMale: '男声',
      defaultVoiceProfile: '默认音色 Profile',
      currentVoiceProfile: '当前：{{profile}}',
      bufferMs: '首段缓冲',
      bufferMsValue: '{{value}} ms',
      bufferMsHelp:
        '首段缓冲控制首段语音开始播放前预先缓存的时长，单位为毫秒。网络或 TTS 生成较慢、开头容易卡顿时调大；希望更快开口时调小。',
      zhSegmentChars: '中文分段字数',
      zhSegmentCharsValue: '{{value}} 字',
      zhSegmentCharsHelp:
        '中文分段字数控制中文回答按多少个汉字切成一段送入 TTS。段越短越快开始播放但衔接更频繁；段越长语气更连贯但等待更久。',
      enSegmentWords: '英文分段词数',
      enSegmentWordsValue: '{{value}} 词',
      enSegmentWordsHelp:
        '英文分段词数控制英文回答按多少个英文词切成一段送入 TTS。英文朗读卡顿时可调小，长句语气不连贯时可调大。',
      preview: '试听',
      saveTts: '保存 TTS 配置',
      ttsPreviewText: '欢迎访问时和专业AI顾问。This is a speech preview.',
      ttsSpeedSlow: '偏慢 0.8x',
      ttsSpeedNormal: '正常 1.0x',
      ttsSpeedSlightlyFast: '稍快 1.15x',
      ttsSpeedFast: '较快 1.3x',
      ttsEmotionProfessional: '专业',
      ttsEmotionCalm: '平静',
      ttsEmotionFriendly: '亲切',
      ttsEmotionFormal: '正式',
      ttsEmotionLively: '活泼',
      ttsEmotionSerious: '严肃',
      ttsDialectMandarin: '普通话',
      ttsDialectCantonese: '粤语/广东话',
      ttsDialectSichuan: '四川',
      ttsDialectShanghai: '上海',
      ttsDialectDongbei: '东北',
      ttsDialectMinnan: '闽南',
      ttsDialectTianjin: '天津',
      ttsDialectShandong: '山东',
      ttsVoiceFemaleMandarin: '女声 / 普通话 / 标准',
      ttsVoiceMaleMandarin: '男声 / 普通话 / 标准',
      ttsVoiceFemaleCantonese: '女声 / 粤语 / 标准',
      ttsVoiceMaleCantonese: '男声 / 粤语 / 标准',
      ttsVoiceFemaleEnglish: '女声 / 英语 / 标准',
      ttsVoiceMaleEnglish: '男声 / 英语 / 标准',
      ttsVoiceProfilesTitle: '声音档案管理',
      ttsVoiceProfilesDescription:
        '录制您的声音并克隆为自定义声音档案，无需提前准备音频样本。',
      ttsVoiceProfilesRefresh: '刷新',
      ttsVoiceProfilesAdd: '新建声音档案',
      ttsVoiceProfilesBuiltIn: '内置档案',
      ttsVoiceProfilesCustom: '自定义档案',
      ttsVoiceProfilesEmpty: '暂无自定义声音档案',
      ttsVoiceProfilesDeleteConfirm:
        '确定要删除声音档案「{{name}}」吗？此操作不可撤销。',
      ttsVoiceProfilesDeleted: '声音档案已删除',
      ttsAddVoiceTitle: '新建声音档案',
      ttsAddVoiceId: '档案 ID',
      ttsAddVoiceIdPlaceholder: 'my_custom_voice',
      ttsAddVoiceIdHelp:
        '仅允许字母、数字、下划线，1-64字符，用于在助手设置中引用此声音',
      ttsAddVoiceDisplayName: '显示名称',
      ttsAddVoiceDisplayNamePlaceholder: '李先生 / 普通话',
      ttsAddVoicePromptText: '录音文本',
      ttsAddVoicePromptTextPlaceholder: '请朗读此文本并录制（建议 5-10 秒）',
      ttsAddVoicePromptTextHelp:
        '请在下方录制时朗读这段文字，CosyVoice3 将以此为声音参考。',
      ttsAddVoiceRecord: '开始录音',
      ttsAddVoiceRecording: '录音中… 点击停止',
      ttsAddVoiceRecorded: '录音完成（{{seconds}}s） — 可试听或重录',
      ttsAddVoicePlay: '试听录音',
      ttsAddVoiceReRecord: '重新录音',
      ttsAddVoiceSave: '保存声音档案',
      ttsAddVoiceSaving: '正在克隆声音…',
      ttsAddVoiceSaved: '声音档案「{{name}}」已创建',
      ttsAddVoiceError: '保存失败：{{error}}',
      ttsAddVoiceOrUpload: '或上传音频文件',
      ttsAddVoiceUploadHint: '支持 WAV / MP3 / M4A / OGG，建议 5-15 秒单人录音',
      ttsAddVoiceNoAudio: '请先录制或上传声音文件',
      ttsAddVoiceTooShort: '音频时长不足 3 秒，请重新录制或更换文件',
      ttsAddVoiceMicError:
        '麦克风不可用（需 HTTPS 或 localhost）。请上传音频文件代替。',
    },
    skills: {
      title: '技能',
...
程序记忆: 学习的技能、习惯和自动化程序。`,
      ...
      memoryType: '记忆类型',
      filterResultCount: '显示 {{current}} / {{total}} 个',
      owner: '所有者',
      embeddingModel: '嵌入模型',
      selectModel: '选择模型',
      llm: '大语言模型',
      ...
      spacetime: {
        ...
        zoom: '缩放',
        reset: '重置视图',
        keywordAnalysis: '关键词关联',
        noKeywords: '暂无关键词关联。',
        selectedMemo: '已选备忘录',
        openMemo: '打开备忘录',
        selectHint: '选择一个圆点查看备忘录。',
        emptyTitle: '暂无可视化备忘录',
        emptyDescription: '请先创建备忘录，或从聊天会话加入备忘录。',
        loaded: '记忆中枢已加载',
        nodes: '个节点',
        viewportControls: '视窗维度与平移控制',
        horizontalPan: '横向日期平移。也可以在右侧画布拖拽。',
        firstDay: '首日',
        globalZoom: '等比例画布缩放',
        spacetimeClues: '时空线索',
        focusDateHint: '选择聚焦日期，修改后立即更新。',
        noTimeRange: '暂无记录',
        memoryExtraction: '记忆提炼 [{{date}}]',
        noDateNodes: '该时空坐标暂无记忆数据',
        memoryFrequency: '记忆频次',
        totalTurns: '累计交互',
        containsCategories: '包含分类',
        timeSpan: '时间跨度',
        emptyDateHint: '系统已将视区平移至该空白时空。',
        keywordClues: '关键词横向关联线索',
        keywordCluesDescription:
          '对全谱多维度关联关系和重叠词进行时空聚类，自动定位并连接全网最强相似回路。',
        analyzeGlobalWeave: '分析全局最强关联织网',
        horizontalReport: '横向线索深度提炼报告',
        strongTies: '强关联纽带',
        subnetwork: '关联子网络',
        horizontalSpan: '横向时空跨度',
        primaryNodeHint:
          '系统已为您定位到该线索的核心枢纽节点「{{topic}}」，相关织网已高亮。',
        selectedPointInfo: '选中记忆点信息',
        createdDate: '生成日期',
        exactTime: '精确时刻',
        turnsScale: '会话交互轮数',
        coreKeywords: '提取的核心关键词',
        sharedMemos: '共享关联的其他备忘录',
        noSharedMemos: '暂无共享关联的其他时空点',
        connectionRule: '连线规则',
        connectionRuleDescription:
          '两个主题只要共享至少一个从主题、摘要或别名中提取出的关键词信号，就会产生曲线连线。上方显示的共享信号就是这条连线的依据；孤立节点表示在当前规则下没有共享信号。',
        relationTooltipTitle: '关系说明',
        relationType: '关系类型',
        relationStrength: '关联强度',
        relationReason:
          '这两个备忘录主题之所以被连接，是因为它们共享以下提取信号：{{terms}}。',
        relationTypes: {
          sharedTopic: '共享核心主题',
          sharedKeywords: '共享关键词',
          crossLanguageTopic: '跨语言同义线索',
        },
        canvasTip:
          '鼠标滚轮滚动时间轴；按住空白处拖拽移动日期；Ctrl/Command + 滚轮缩放。',
        dateAxis: '日期',
        timeAxis: '时刻',
      },
      profile: {
        ...
        whatIsProfile: '思维画像是什么',
        whatIsProfileDescription:
          '这里不是推断人格，而是把已保存备忘录中的主题、证据密度、时间顺序和近期活跃变化整理出来，并让每个结论都能回到具体备忘录。',
        topTopics: '最关注主题',
        ...
        analysisPending: '正在更新思维画像',
        analysisPendingDescription:
          '页面会优先显示缓存画像；新的画像快照正在后台生成，完成后会自动刷新。',
        currentProfile: '当前思维画像',
        focusDomains: '关注领域',
        snapshot: '分析快照',
        generatedAt: '生成时间',
        eventCount: '思维事件',
        ...
        pathMap: '思维路径图',
        pathMapDescription:
          '横轴是时间，纵轴是主题领域。节点代表保存到备忘录的思维事件，曲线解释主题之间的关系。',
        edgeEvidence: '关系证据',
        openEvidenceMemo: '打开来源备忘录',
        predictedQuestions: '可能继续关心的问题',
        topicMergeSuggestions: '主题合并建议',
        topicMergeSuggestionsDescription:
          '只有当两个主题确实是同一概念的不同说法或不同语言表达时，再确认合并。',
        mergeTo: '合并到',
        mergeConfidence: '置信度',
        confirmMerge: '确认合并',
    ...
    memory: {
      messages: {
        ...
        copied: '已复制！',
        contentEmbedHint: '嵌入向量用于语义检索，普通查看时已隐藏。',
        content: '内容',
        emptyMemoTitle: '暂无备忘录内容',
        emptyMemoDescription:
          '这里显示已经写入并可被检索的记忆消息。若为空，说明该备忘录还没有成功保存会话摘要，或后台记忆提取任务尚未完成。',
...
例如：一条带有 1024 维嵌入的 1 KB 消息大约使用 9 KB。5 MB 的默认限制大约可容纳 500 条此类消息。`,
    ...
    knowledgeDetails: {
      ...
      retrievalTestingDescription:
        '进行检索测试，检查 Panython 是否能够为大语言模型（LLM）恢复预期的内容。',
      Parse: '解析',
      dataset: '知识库',
      testing: '检索测试',
      configuration: '配置',
      ...
      parsingStatus: '解析状态',
      parsingStatusTip:
        '文本解析的时间取决于诸多因素。如果开启了知识图谱、RAPTOR、自动问题提取、自动关键词提取等功能，时间会更长。如果解析进度条长时间不更新，也可以参考这两条 FAQ：https://Panython.io/docs/dev/faq#why-does-my-document-parsing-stall-at-under-one-percent。',
      processBeginAt: '开始于',
      ...
      layoutRecognizeTip:
        '使用视觉模型进行 PDF 布局分析，以更好地识别文档结构，找到标题、文本块、图像和表格的位置。 如果选择 Naive 选项，则只能获取 PDF 的纯文本。请注意该功能只适用于 PDF 文档，对其他文档不生效。欲了解更多信息，请参阅 https://Panython.io/docs/dev/select_pdf_parser。',
      taskPageSize: '任务页面大小',
      ...
      uploadDescription:
        '支持单次或批量上传。本地部署的单次上传文件总大小上限为 1GB，单次批量上传文件数不超过 32，单个账户不限文件数量。对于 cloud.Panython.io：每次上传的总文件大小限制为 10MB，每个文件不得超过 10MB，每个账户最多可上传 128 个文件。严禁上传违禁文件。',
      chunk: '解析块',
      bulk: '批量',
      cancel: '取消',
      close: '关闭',
      ...
      rerankTip: `非必选项：若不选择 rerank 模型，系统将默认采用关键词相似度与向量余弦相似度相结合的混合查询方式；如果设置了 rerank 模型，则混合查询中的向量相似度部分将被 rerank 打分替代。请注意：采用 rerank 模型会非常耗时。如需选用 rerank 模型，建议使用 SaaS 的 rerank 模型服务；如果你倾向使用本地部署的 rerank 模型，请务必确保你使用 docker-compose-gpu.yml 启动 Panython。`,
      topK: 'Top-K',
      ...
      html4excel: '表格转HTML',
      html4excelTip: `与 General 切片方法配合使用。未开启状态下，表格文件（XLSX、XLS（Excel 97-2003））会按行解析为键值对。开启后，表格文件会被解析为 HTML 表格。若原始表格超过 12 行，系统会自动按每 12 行拆分为多个 HTML 表格。欲了解更多详情，请参阅 https://Panython.io/docs/dev/enable_excel2html。`,
      autoKeywords: '自动关键词提取',
      autoKeywordsTip: `自动为每个文本块中提取 N 个关键词，用以提升查询精度。请注意：该功能采用在“配置”中指定的索引模型提取关键词，因此也会产生更多 Token 消耗。另外，你也可以手动更新生成的关键词。详情请见 https://Panython.io/docs/dev/autokeyword_autoquestion。`,
      autoQuestions: '自动问题提取',
      autoQuestionsTip: `利用在“配置”中指定的索引模型 对知识库的每个文本块提取 N 个问题以提高其排名得分。请注意，开启后将消耗额外的 token。您可以在块列表中查看、编辑结果。如果自动问题提取发生错误，不会妨碍整个分块过程，只会将空结果添加到原始文本块。详情请见 https://Panython.io/docs/dev/autokeyword_autoquestion。`,
...
`,
    ...
    <p>
      ...
      您只需与<i>'Panython'</i>交谈即可列出所有符合资格的候选人。
      </p>
        `,
...
`,
      ...
      useRaptorTip:
        'RAPTOR 常应用于复杂的多跳问答任务。如需打开，请跳转至知识库的文件页面，点击生成 > RAPTOR 开启。详见: https://Panython.io/docs/dev/enable_raptor。',
      prompt: '提示词',
...
以上就是你需要总结的内容。`,
      ...
      entityTypes: '实体类型',
      pageRank: '页面排名',
      pageRankTip: `知识库检索时，你可以为特定知识库设置较高的 PageRank 分数，该知识库中匹配文本块的混合相似度得分会自动叠加 PageRank 分数，从而提升排序权重。详见 https://Panython.io/docs/dev/set_page_rank。`,
      tagName: '标签',
      frequency: '频次',
      searchTags: '搜索标签',
      tagCloud: '云',
      ...
      <p> 详见：https://Panython.io/docs/dev/use_tag_sets </p>
      `,
      tags: '标签',
      addTag: '增加标签',
      useGraphRag: '提取知识图谱',
      useGraphRagTip:
        '基于知识库内所有切好的文本块构建知识图谱，用以提升多跳和复杂问题回答的正确率。请注意：构建知识图谱将消耗大量 token 和时间。详见 https://Panython.io/docs/dev/construct_knowledge_graph。',
      graphRagMethod: '方法',
...
NER：使用 spaCy NER 和基于规则的关键词提取来抽取实体和关系，无需 LLM 参与提取过程，速度快且资源消耗低`,
    ...
    chat: {
      ...
      exit: '退出',
      multipleModels: '多模型',
      waitForGenerationBeforeSwitch: '回答生成中，请等待完成后再切换视图。',
      applyModelConfigs: '应用模型配置',
      conversations: '会话',
      chatApps: '聊天',
      createChat: '创建聊天',
      chatAssistantCount: '共 {{count}} 位聊天助手',
      createChatAssistant: '创建聊天助手',
      historySessionCount: '共 {{count}} 条历史会话',
      startChat: '发起聊天',
      newConversation: '新会话',
      ...
      knowledgeBases: '知识库',
      addToMemory: '加入备忘录',
      addToMemorySuccess: '已加入备忘录，可在备忘录页面查看',
      addToMemoryFailed: '加入备忘录失败',
      addToMemoryPreparing: '请先开始一个有效会话，再加入备忘录',
      addToMemoryTopicPrompt:
        '备忘录主题（可选）。留空则使用会话中的首个问题作为主题，内容会先写入备忘录。',
      addToMemoryTopicPlaceholder: '输入一个简短主题',
      viewMemory: '查看备忘录',
      deepThinking: '深度思考',
      deepThinkingTip:
        '开启后，本次问题会启用更深入的推理路径，适合复杂分析、多步推理和需要更细证据整理的问题；回答可能更慢，也会占用更多上下文。',
      deleteTurn: '删除此轮问答',
      deleteTurnTitle: '删除此轮问答？',
      deleteTurnDescription:
        '将从当前会话中移除选中的问题及其回答。删除后，这些内容不会在加入备忘录时被整理进备忘录。',
      processRunning: '正在处理...',
      processShow: '查看推理与检索过程',
      processHide: '收起推理与检索过程',
      processTimeline: '执行过程',
      processAnalyze: '分析问题',
      processRetrieve: '检索知识库',
      processReason: '推理与整理',
      processCompose: '生成回答',
      processDone: '已完成',
      processInProgress: '进行中',
      processPending: '等待中',
      ds4HealthTitle: '模型上下文健康',
      ds4HealthUsage: '占用 {{percent}}%',
      ds4HealthRemaining: '剩余 {{tokens}} tokens',
      ds4HealthReady: '模型可用，上下文占用处于安全区间。',
      ds4HealthWarning: '上下文占用偏高，系统会优先排队并控制请求。',
      ds4HealthCritical: '上下文占用接近上限，可能触发自动维护。',
      ds4HealthMaintenance:
        '模型正在清理上下文缓存或重启，新的回答会等待服务恢复。',
      ds4HealthWarming: '模型正在预热加载，请稍后继续。',
      ds4HealthState: '运行状态',
      ds4HealthContextUsage: '当前上下文占用',
      ds4HealthUsageRatio: '占用比例',
      ds4HealthAvailableContext: '可用上下文',
      ds4HealthMaintenanceThreshold: '自动维护阈值',
      ds4HealthReason: '状态原因',
      ds4HealthState_ready: '就绪',
      ds4HealthState_starting: '启动中',
      ds4HealthState_warming: '预热中',
      ds4HealthState_maintenance: '维护中',
      ds4HealthState_restarting: '重启中',
      ds4HealthState_degraded: '不稳定',
      ds4HealthState_unknown: '未知',
      retrieving: 'Retrieving...',
      retrieved: 'Retrieved',
      thinking: 'Thinking...',
      thought: 'Thought',
      longTaskDetectedTitle: '已识别为长篇生成任务',
      longTaskSummary:
        '这个请求更适合按章节生成 Markdown 文档，避免聊天窗口回答被截断。',
      longTaskReason: '原因',
      longTaskReasonLength: '请求中包含明确的长篇字数目标。',
      longTaskReasonType: '请求匹配长报告、小说、研究类等长篇生成任务。',
      longTaskOutline: '大纲',
      longTaskButtonHint:
        '点击下方按钮后，系统会按大纲分段生成 Markdown 文档。',
      generateMarkdownDocument: '生成 Markdown 文档',
      markdownDocumentReady: 'Markdown 文档已生成。',
      markdownDocumentFailed: '生成 Markdown 文档失败。',
      continueGenerating: '继续生成',
      continueInstruction:
        '请从上一条回答中断的位置继续，不要重复已经输出的内容。',
      longTaskNovelOutline1: '故事前提、世界观与核心冲突',
      longTaskNovelOutline2: '主要人物与关系变化',
      longTaskNovelOutline3: '章节推进与关键情节',
      longTaskNovelOutline4: '转折、高潮与结局',
      longTaskResearchOutline1: '研究目标与范围',
      longTaskResearchOutline2: '关键事实、证据与假设',
      longTaskResearchOutline3: '分析框架与主要发现',
      longTaskResearchOutline4: '结论、风险与下一步建议',
      longTaskReportOutline1: '执行摘要与背景',
      longTaskReportOutline2: '主要论点与支撑证据',
      longTaskReportOutline3: '分章节详细分析',
      ...
      recallEmpty: '提问后这里将显示召回的证据与文档',
      recallDocumentsCount: '{{count}} 个文档',
      evidenceAuditStats:
      ...
      answerEvidencePlanHint:
        '逐条说明回答结论引用了哪些证据，以及该证据的可靠程度',
      evidenceStrengthStrong: '强证据',
      evidenceStrengthMedium: '中等证据',
      evidenceStrengthWeak: '弱证据',
      evidenceStrengthUnknown: '证据未知',
      evidenceCitesLabel: '引用',
      recallExpand: '放大',
      recallCollapse: '还原',
      openEvidenceInRecall: '打开 Fig. {{fig}} 详情',
      evidenceAuditSourceId: '原始ID',
      summaryCitation: '引用摘要',
      relatedOriginalChunks: '关联原文片段',
      messageRenderError: '这条历史消息包含不兼容内容，已跳过渲染。',
      voiceStart: '开始语音输入',
      voiceRecording: '正在录音，点击停止',
      voiceProcessing: '正在转写语音',
      voiceNoText: '没有识别到有效语音',
      voiceError: '语音转写失败，请检查麦克风权限和语音识别模型配置',
...
**重要规则:**
  ...
  - **始终考虑**整个对话历史。`,
      ...
      “系统提示词”中的所有变量都必须用大括号{}括起来。详见 https://Panython.io/docs/dev/set_chat_variables。`,
      add: '新增',
      key: '关键字',
      optional: '可选的',
      operation: '操作',
      ...
      ttsEmotionProfessional: '专业',
      ttsEmotionCalm: '平静',
      ttsEmotionFriendly: '亲和',
      ttsEmotionFormal: '正式',
      ttsEmotionLively: '活泼',
      ttsEmotionSerious: '严肃',
      ttsDialect: '中文方言',
      ttsDialectMandarin: '普通话',
      ttsDialectCantonese: '粤语',
      ttsDialectSichuan: '四川话',
      ttsDialectShanghai: '上海话',
      ttsDialectDongbei: '东北话',
...
示例：general/v2/`,
      ...
      ttsModel: 'TTS',
      ttsModelTip:
        '默认的tts模型会被用于在对话过程中请求语音生成时使用。如未显示可选模型，请根据 https://Panython.io/docs/dev/supported_models 确认你的模型供应商是否提供该模型。',
      embeddingModel: 'Embedding',
      embeddingModelTip:
        '所有新创建的知识库使用的默认嵌入模型。如未显示可选模型，请检查你是否在使用 Panython slim 版(不含嵌入模型)；或根据 https://Panython.io/docs/dev/supported_models 确认你的模型供应商是否提供该模型。',
      img2txtModel: 'VLM',
      img2txtModelTip:
        '所有新创建的知识库都将使用默认的 img2txt 模型。 它可以描述图片或视频。如未显示可选模型，请根据 https://Panython.io/docs/dev/supported_models 确认你的模型供应商是否提供该模型。',
      sequence2txtModel: 'ASR',
      sequence2txtModelTip:
        '所有新创建的知识库都将使用默认的 ASR 模型。 使用此模型将语音翻译为相应的文本。如未显示可选模型，请根据 https://Panython.io/docs/dev/supported_models 确认你的模型供应商是否提供该模型。',
      rerankModel: 'Rerank',
      rerankModelTip: `默认的 reranking 模型。如未显示可选模型，请根据 https://Panython.io/docs/dev/supported_models 确认你的模型供应商是否提供该模型。`,
      workspace: '工作空间',
      upgrade: '升级',
      addLlmTitle: '添加 LLM',
...
[在此处插入法律文本]`,
    ...
    search: {
      ...
      copySuccess: '复制成功',
      welcomeBack: '欢迎回来',
      resultsSummary: '找到 {{docs}} 个文档，包含 {{chunks}} 个命中片段',
      hitChunks: '{{count}} 个片段',
      openDocument: '打开文档',
