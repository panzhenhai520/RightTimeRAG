      ...
      <PageHeader>
        <section className="flex items-center gap-3">
          ...
          <button
            ...
            className={cn(
              'flex size-10 shrink-0 items-center justify-center rounded-full cursor-pointer',
              isDarkTheme &&
          ...
          <div>
            <h2 className="text-base font-semibold text-[#153f73] dark:text-[#e4eef4] leading-tight">
              {agentDetail.title}
            </h2>
