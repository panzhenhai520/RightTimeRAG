...
Örnek: 1024 boyutlu embedding ile 1 KB'lık bir mesaj ~9 KB kullanır. 5 MB varsayılan sınır ~500 mesaj tutar.`,
    ...
    knowledgeDetails: {
      ...
      retrievalTestingDescription:
        "Panython'nun LLM için hedeflenen içeriği alıp alamadığını kontrol etmek için bir alım testi yapın.",
      Parse: 'Ayrıştır',
      dataset: 'Dataset',
      testing: 'Alım testi',
      files: 'dosyalar',
      ...
      uploadDescription:
        'Tekil veya toplu dosya yüklemeyi destekler. Yerel olarak dağıtılan Panython için: yükleme başına toplam dosya boyutu sınırı 1GB, 32 dosyalık toplu yükleme sınırı vardır. Hesap başına toplam dosya sayısında sınır yoktur. cloud.Panython.io için yükleme başına toplam dosya boyutu sınırı 10MB, her dosya en fazla 10MB ve hesap başına en fazla 128 dosya.',
      chunk: 'Parça',
      bulk: 'Toplu',
      cancel: 'İptal',
      close: 'Kapat',
      ...
      rerankTip: `İsteğe bağlı. Boş bırakılırsa Panython ağırlıklı anahtar kelime benzerliği ve ağırlıklı vektör kosinüs benzerliğinin kombinasyonunu kullanır; yeniden sıralama modeli seçilirse ağırlıklı yeniden sıralama puanı ağırlıklı vektör kosinüs benzerliğinin yerini alır. Yeniden sıralama modeli kullanmanın sistemin yanıt süresini önemli ölçüde artıracağını unutmayın. Yeniden sıralama modeli kullanmak istiyorsanız bir SaaS yeniden sıralayıcı kullandığınızdan emin olun; yerel olarak dağıtılmış yeniden sıralama modelini tercih ediyorsanız Panython'u docker-compose-gpu.yml ile başlattığınızdan emin olun.`,
      topK: 'Top-K',
...
`,
      useRaptor: 'RAPTOR',
      useRaptorTip:
        "RAPTOR çok adımlı soru-cevap görevleri için kullanılabilir. Dosyalar sayfasına gidin, Oluştur > RAPTOR'a tıklayarak etkinleştirin. Ayrıntılar için bkz. https://Panython.io/docs/dev/enable_raptor.",
      prompt: 'İstem',
      promptTip:
...
Yukarısı özetlemeniz gereken içeriktir.`,
      ...
      pageRankTip: `Alım sırasında belirli datasets'e daha yüksek PageRank puanı atayabilirsiniz. İlgili puan, bu datasetlerden alınan parçaların hibrit benzerlik puanlarına eklenir ve sıralamalarını yükseltir. Ayrıntılar için bkz. https://Panython.io/docs/dev/set_page_rank.`,
      tagName: 'Etiket',
      frequency: 'Sıklık',
      ...
      tagSetTip: `
     <p> Dataset'inizdeki parçaları otomatik olarak etiketlemek için bir veya birden fazla etiket dataset seçin. Ayrıntılar için bkz. https://Panython.io/docs/dev/use_tag_sets.</p>
...
<ul>
  ...
  <li>Otomatik anahtar kelime özelliği LLM'e bağımlıdır ve önemli miktarda token tüketir.</li>
      ...
      useGraphRagTip:
        'İç içe geçmiş mantık içeren çok adımlı soru-cevabı geliştirmek için mevcut dataset dosya parçaları üzerinde bir bilgi grafiği oluşturun. Ayrıntılar için bkz. https://Panython.io/docs/dev/construct_knowledge_graph.',
      graphRagMethod: 'Yöntem',
      graphRagMethodTip: `
      Hafif: (Varsayılan) Varlıkları ve ilişkileri çıkarmak için HKUDS/LightRAG tarafından sağlanan istemler kullanılır.</br>
      Genel: Varlıkları ve ilişkileri çıkarmak için Microsoft GraphRAG tarafından sağlanan istemler kullanılır.</br>
    ...
    chat: {
      ...
      addToMemory: 'Notlara ekle',
      addToMemorySuccess: 'Notlara eklendi. Notlar sayfasında görüntüleyin.',
      addToMemoryFailed: 'Notlara eklenemedi',
      addToMemoryPreparing:
        'Notlara eklemeden önce geçerli bir konuşma başlatın.',
      viewMemory: 'Notu görüntüle',
...
**Temel Kurallar:**
  ...
  - **Her zaman** konuşma geçmişinin tamamını göz önünde bulundurun.`,
      ...
      **Temel Kurallar:**
      ...
      variable: 'Değişken',
      variableTip: `Panython'nun sohbet asistanı yönetim API'leri ile birlikte kullanılır.`,
      add: 'Ekle',
      key: 'Anahtar',
      ...
      betaError:
        'Lütfen önce Sistem Ayarları sayfasından bir Panython API anahtarı edinin.',
      searching: 'Aranıyor...',
    ...
    setting: {
      ...
      embeddingModelTip:
        'Her yeni oluşturulan dataset için varsayılan embedding model. Açılır listede bir embedding model bulamıyorsanız, Panython slim sürümünü (embedding modeller içermez) kullanıp kullanmadığınızı kontrol edin veya model sağlayıcınızın bu modeli destekleyip desteklemediğini görmek için https://Panython.io/docs/dev/supported_models adresine bakın.',
      img2txtModel: 'VLM',
      img2txtModelTip:
        'Her yeni oluşturulan dataset için varsayılan VLM. Bir resmi veya videoyu tanımlar. Açılır listede bir model bulamıyorsanız, model sağlayıcınızın bu modeli destekleyip desteklemediğini görmek için https://Panython.io/docs/dev/supported_models adresine bakın.',
      ...
      rerankModel: 'Rerank',
      rerankModelTip: `Parçaları yeniden sıralamak için varsayılan yeniden sıralama modeli. Açılır listede bir model bulamıyorsanız, model sağlayıcınızın bu modeli destekleyip desteklemediğini görmek için https://Panython.io/docs/dev/supported_models adresine bakın.`,
      ttsModel: 'TTS',
      ttsModelTip:
        'Varsayılan metin-konuşma dönüştürme modeli. Açılır listede bir model bulamıyorsanız, model sağlayıcınızın bu modeli destekleyip desteklemediğini görmek için https://Panython.io/docs/dev/supported_models adresine bakın.',
    ...
    fileManager: {
      ...
      uploadTitle: 'Yüklemek için dosyanızı buraya sürükleyip bırakın',
      uploadDescription:
        'Tekil veya toplu dosya yüklemeyi destekler. Yerel Panython için 1GB sınır, 32 dosya toplu yükleme sınırı.',
...
En uygun olduğu durumlar: Anlatı bütünlüğünün bitişik paragrafları birlikte tutmaya bağlı olduğu kitaplar, kılavuzlar, raporlar ve makaleler gibi akıcı, bağlamsal olarak bağlantılı içeriğe sahip belgeler.`,
  ...
  Yukarısı özetlemeniz gereken içeriktir.`,
      ...
      gitHub: 'GitHub',
      gitHubDescription: 'GitHub adresinden depo arayan bir bileşen.',
